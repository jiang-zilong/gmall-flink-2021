...
import com.jzl.bean.Bean1;
import com.jzl.bean.Bean2;
...
public class FlinkDataStreamJoinTest {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Bean1> stream1 = env.socketTextStream("localhost", 8888)
                .map(line -> {
        ...
        SingleOutputStreamOperator<Bean2> stream2 = env.socketTextStream("localhost", 9999)
                .map(line -> {
                    String[] fields = line.split(",");
