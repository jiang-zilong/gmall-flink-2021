...
import com.jiangzilong.bean.ProductStats;
import com.jiangzilong.common.GmallConstant;
...
/*      env.setStateBackend(new FsStateBackend("hdfs://hadoop111:8020/gmall-flink-210325/ck"));
        ...
        SingleOutputStreamOperator<ProductStats> productStatsWithClickAndDisplayDS = pvDS.flatMap(new FlatMapFunction<String, ProductStats>() {
            ...
            public void flatMap(String value, Collector<ProductStats> out) throws Exception {
                ...
                if ("good_detail".equals(page) && "sku_id".equals(pageId)) {
        ...
        productStatsWithTmDS.addSink(ClickHouseUtil.getSink("insert into table product_stats_210325 " +
                "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"));
